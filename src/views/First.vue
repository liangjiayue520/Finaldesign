		...
		<el-row>
			...
			<el-col :span="14">
				<el-row>
					...
					<iframe frameborder="0"  scrolling="no"   src="static/春运迁徙.html" style=" width: 100%;height:400px"></iframe>
				</el-row>	
			</el-col>
		</el-row>
		<el-row>
			<el-col :span="24">
				...
				<iframe frameborder="0"    src="static/heatmap-cartesian.html" style=" width: 100%;height:400px"></iframe>
			</el-col>
		</el-row>
		<el-row>
			<el-col :span="12">
				<div class="heatmap"></div>
				<iframe frameborder="0" src="static/聚类散点.html" style=" width: 100%;height:600px"></iframe>
			</el-col>
			<el-col :span="12">
				<div class="heatmap"></div>
				<iframe frameborder="0" src="static/动态柱状图final.html" style=" width: 100%;height:600px"></iframe>
			</el-col>
		</el-row>
	</div>
</template>
